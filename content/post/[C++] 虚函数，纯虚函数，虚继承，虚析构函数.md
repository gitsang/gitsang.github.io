...
movq    -40(%rbp), %rax
movq    %rax, %rdi
call    _ZN4Base5printEv # 地址标号直接寻址，跳转到Base类的print
```
...
2. [浅谈C++多态性](https://blog.csdn.net/Hackbuteer1/article/details/7475622)
3. [C++多态--虚函数virtual及override](https://blog.csdn.net/i_chaoren/article/details/77281785)
4. [C++学习:虚函数,纯虚函数(virtual),虚继承,虚析构函数](https://blog.csdn.net/qq_29924041/article/details/73522256)
5. [C++ Virtual详解](https://blog.csdn.net/ring0hx/article/details/1605254)
6. [C++中virtual（虚函数）的用法](https://blog.csdn.net/foreverhuylee/article/details/34107615)
